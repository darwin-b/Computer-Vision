...
class YOLO(nn.Module):
    ...
    def create_modules(self):
        ...
        modules.add_module("conv_1",nn.Conv2d(3, 16, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)))
        modules.add_module("relu_1",nn.ReLU())
        modules.add_module("maxpool_1",nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False))

        modules.add_module("conv_2",nn.Conv2d(16, 32, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)))
        modules.add_module("relu_2",nn.ReLU())
        modules.add_module("maxpool_2",nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False))


        modules.add_module("conv_3",nn.Conv2d(32, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)))
        modules.add_module("relu_3",nn.ReLU())
        modules.add_module("maxpool_3",nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False))


        modules.add_module("conv_4",nn.Conv2d(64, 128, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)))
        modules.add_module("relu_4",nn.ReLU())
        modules.add_module("maxpool_4",nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False))

        modules.add_module("conv_5",nn.Conv2d(128, 256, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)))
        modules.add_module("relu_5",nn.ReLU())
        modules.add_module("maxpool_5",nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False))

        modules.add_module("conv_6",nn.Conv2d(256, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)))
        modules.add_module("relu_6",nn.ReLU())
        modules.add_module("maxpool_6",nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False))
